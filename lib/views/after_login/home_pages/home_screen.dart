...
class _HomeScreenState extends State<HomeScreen> {
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                ...
                child: Text("", style: text14(color: AppColors.primary)),
              ),
            ],
          ),
        ),
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Icon(
                            canWatch ? Icons.play_arrow_rounded : Icons.lock_outline,
                            color: Colors.white,
                            size: 40,
                          ),
                        ),
  ...
  Widget _buildTrendingSeries(List<series_model.Series> series) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader("Trending Series", "", onActionTap: () {
          ctr.handleProtectedAction(() {
            Get.toNamed(AppRoutes.selectSeries);
          });
        }),
        const SizedBox(height: 14),
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Obx(() {
                final canWatch = Get.find<PlanController>().canWatchSeries(item);
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
                      image: DecorationImage(
                        image: match.thumbnail != null && match.thumbnail!
                            .isNotEmpty
                            ? NetworkImage(match.thumbnail!)
                            : const AssetImage(
                            'assets/auth/cri.png') as ImageProvider,
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
